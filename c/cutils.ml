...
let u32toa buf n = Quickjs_bindings.C.Functions.u32toa buf n

(** Convert signed 32-bit integer to decimal string *)
let i32toa buf n = Quickjs_bindings.C.Functions.i32toa buf n

(** Convert unsigned 64-bit integer to decimal string *)
let u64toa buf n = Quickjs_bindings.C.Functions.u64toa buf n

(** Convert signed 64-bit integer to decimal string *)
let i64toa buf n = Quickjs_bindings.C.Functions.i64toa buf n

(** Convert unsigned 64-bit integer to string in given radix (2-36) *)
let u64toa_radix buf n radix =
  Quickjs_bindings.C.Functions.u64toa_radix buf n radix

(** Convert signed 64-bit integer to string in given radix (2-36) *)
let i64toa_radix buf n radix =
  Quickjs_bindings.C.Functions.i64toa_radix buf n radix
